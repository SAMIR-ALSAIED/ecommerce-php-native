					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 01225399159</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> samir@gamil.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
		...
		while($row= $result ->fetch_assoc()){
			?>
				...
				?>">
						...
						<div class="col-sm-6">
							<img src="admin/assets/<?= $row['image'] ?>"  style="width:350px;height:300px" />
						</div>
					</div>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							$select_cat="SELECT * FROM catgory";
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								while($brand = $result_brand -> fetch_assoc()){
									...
									<li><a href="#"> <span class="pull-right">(<?php
			...
			?>
				...
				<div class="col-sm-4  aa" >
					...
					<div class="productinfo text-center">
						<img src="admin/assets /<?= $row['image']?>" style="width:200px;height:200px; margin-bottom: 20px;   margin-top: 19px;
" />
						<h4><?= $row['name'] ?></h4>
						<h2><?=$row ['price'] ?></h2>
